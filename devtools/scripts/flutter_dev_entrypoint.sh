...
exec sudo --preserve-env=REPO_ROOT,HOST_UID,HOST_GID,FLUTTER_PROJECT_SOURCE_CODE_PATH,FLUTTER_BOLT_NAME,STB_IP,FLUTTER_APPLICATION_RECIPE,SSTATE_PATH,DOWNLOADS_PATH,INIT_CACHE_PATH,FIRST_TIME_INIT_LOG,TMUX_INIT_SCRIPT,BOLT_BUILD_VOLUME_NAME,FLUTTER_SERIES -H -u flutter-dev bash <<'EOF'
