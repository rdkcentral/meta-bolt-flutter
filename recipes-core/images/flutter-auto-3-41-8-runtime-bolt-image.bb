...
# this runtime includes the flutter-engine version 3.41.8 and flutter-auto embedder with wayland-egl/gles2 backend that can launch associated flutter RDK bolt apps
